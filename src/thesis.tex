...
\usepackage{amsmath,amsfonts,amsthm,commands,thesis,graphicx}
...
% thesis       : Provides thesis format (locally defined)
...
% Committee
%***********
% The thesis.sty file must be edited for more than six committee members
\advisor {(advisor)}
\isechair{(ISE chair)}
